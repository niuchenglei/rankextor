#ifndef XFEA_BISHENG_FEATURE_OP_S_DIRECT_H_
#define XFEA_BISHENG_FEATURE_OP_S_DIRECT_H_
...
// 根据单个字段的内容直接生产特征
class S_direct : public SingleSlotFeatureOp {
public:
    S_direct(): _output_ratio(0.0) {
        // Nothing to do
    }
